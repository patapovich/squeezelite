...
void set_volume(unsigned left, unsigned right) {
	...
	// if external volume script is set, call it (shared helper in output.c —
	// same -72 dB floor, OUTPUT_OFF/STOPPED/PAUSE_FRAMES gate and backgrounded
	// system() as the ALSA/PortAudio paths).
	if (volume_script) {
